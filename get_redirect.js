        ...
        data.forEach(element => {
            sales.innerHTML += `
                    <tr>
                        ...
                        <br>
                        <td><b>Nombre del Vendedor: </b> ${element.nameVendedor}</td>
                        <br>
                        <td><b>Nombre del Cliente: </b> ${element.nameCliente}</td>
                        <br>
                        <td><b>Nombre del Producto: </b> ${element.nameProducto}</td>
                        <br>
                        <td><b>Precio: </b> ${element.price}</td>
                        <br>
                        <td><b>Fecha Compra: </b> ${element.fechaCompra}</td>
                        <br>
